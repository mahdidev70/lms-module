        ...
        return [
            ...
            'chapters' => $this->chapters->map(fn ($chapter) => [
                ...
                'lessons' => $chapter->lessons->map(fn ($lesson) => [
                    ...
                    'minutesToRead' => ($lesson->dominant_type == 'text') ? $this->duration : null,
                    'duration' => ($lesson->dominant_type == 'video') ? $this->duration : null,
                    'numberOfQuestions' => ($lesson->dominant_type == 'exam') ? $this->duration : null,
